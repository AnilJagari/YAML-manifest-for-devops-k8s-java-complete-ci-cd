    ...
    stages {
        ...
        stage("Checkout from SCM") {
            steps {
                ...
                url: 'https://github.com/AnilJagari/YAML-manifest-for-devops-k8s-java-complete-ci-cd'
            }
        }
            ...
            steps {
                ...
                withCredentials([gitUsernamePassword(credentialsId: 'github', gitToolName: 'Default')]) {
                    ...
                    sh '''
                        ...
                        git commit -m "Updated Kubernetes Manifest with New Image Tag" || true

                        git push https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/AnilJagari/YAML-manifest-for-devops-k8s-java-complete-ci-cd.git main
                    '''
                }
            }
        }
